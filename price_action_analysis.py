...
nifty_file=pd.read_csv('../data/index_company_lists/Nifty_yahoo_ticker.csv', index_col=0)
os.makedirs('Image_today', exist_ok=True)
...
for num in range(len(nifty_file)):
    ...
    os.makedirs(f"Image_today/{company}", exist_ok=True)
